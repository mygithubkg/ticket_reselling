      ...
      <div className={styles.upperHeader}>
        <div className={styles.header} ref={headerRef}>
          <motion.div
            ...
            animate={{ opacity: 1, x: 0, scale: [1, 1, 1.5, 1] }}
            transition={{
              type: "spring",
              staggerChildren: 10,
              y: { type: "spring" },
            ...
            className={styles.header_space1}
          >
            <img src="" height="100%" alt="" />
            <Link to="/" className={styles.logoLink}>
              <h1 id={styles.logo}>
                Trade<p className={styles.my}>My</p>Ticket
              </h1>
            </Link>
          </motion.div>
          <motion.div
            ...
            initial="hidden"
            animate="show"
            className={styles.header_space2}
          >
            <Link to="/Explore" className={styles.logoLink1}>
              <motion.p whileHover={middlevar.whileHover} variants={middlevar}>
                Explore
              </motion.p>
            </Link>
          ...
          <div className={styles.header_space3}>
            ...
            >
              <Link to="/Seller1" className={styles.sell_button}>
                Sell
              </Link>
            </motion.div>
