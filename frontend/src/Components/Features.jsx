...
const features_buyer = [
  {
    ...
    info: "Rest assured with our secondary ticket reselling platform, where every seller is carefully verified to ensure authenticity and reliability. You can buy tickets with confidence, knowing they come from trusted sources.",
  },
  {
    img: "/fee.png",
      ...
      <div>
        ...
        <motion.div ref={container} className="box-container">
          {features_buyer.map((feature, index) => (
            <motion.div
              style={{ scale, top: `calc(10% + ${index * 0}px)` }}
              // `calc(10% + ${index * 1}px)`
              className="box1"
            >
              <div className="feature_image">
                <img src={feature.img} alt="Placeholder" />
              </div>
